...
public class BookAppointmentActivity extends AppCompatActivity {
   ...
   EditText ed1,ed2,ed3,ed4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBook=findViewById(R.id.buttonDoctorBookAppointment);
...
//(username,title+" => "+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1)
